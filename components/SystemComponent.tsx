...
export default function SystemComponent(props: any) {
  ...
  let decalFactor = props.decalFactor
  let pos = [(indexX - length1/2 + 0.5)*decalFactor + x,(indexY - length2/2 + 0.5)*decalFactor + y,(indexZ - length3/2 + 0.5)*decalFactor + z]
  ...
  return (
    ...
    >
        ...
        color={0x2ff955}/>
        {
            ...
            position={
                [
                    (indexX - length1/2 + 0.5)*decalFactor + item.pos.x,
                    (indexY - length2/2 + 0.5)*decalFactor + item.pos.y,
                    (indexZ - length3/2 + 0.5)*decalFactor + item.pos.z
                ]
            }
            color={'orange'}
            />)
